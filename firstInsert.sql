...
INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220415100000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220415110000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220415120000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220415130000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220415140000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220415150000', 'YYYYMMDDHH24MISS'));
    
INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220417100000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220417110000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220417120000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220417130000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220417140000', 'YYYYMMDDHH24MISS'));

INSERT INTO TB_PT_CALENDAR (PT_CALENDAR_NO, PT_NO, MEMBER_NO, PT_CALENDAR_START_TIME, PT_CALENDAR_RESERVATION_STATE) 
    VALUES ((SELECT nvl(max(PT_CALENDAR_NO),0)+1 from TB_PT_CALENDAR), 1, 2, to_date('20220417150000', 'YYYYMMDDHH24MISS'));
...
INSERT INTO TB_COMMENT (COMMENT_NO, BOARD_NO, MEMBER_NO, COMMENT_CONTENT, COMMENT_DATE, COMMENT_EDIT_DATE)
    VALUES((SELECT NVL(MAX(RECOMMENT_NO),0)+1 FROM TB_COMMENT), 2, 1, '댓글 내용', DEFAULT, NULL);
