 ...
 */
@WebServlet("/insertForPwd")
public class InsertMailAndNumberForPwdController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertMailAndNumberForPwdController() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//아이디, 성명과 이메일의 정보가 있으면
		MemberVo vo = new MemberService().findPwdfromIdAndNameAndEmail(memberId, memberName, emailCertificationEmail);
		if(vo == null) {
