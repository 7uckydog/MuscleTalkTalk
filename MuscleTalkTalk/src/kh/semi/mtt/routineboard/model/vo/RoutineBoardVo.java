...
//	BOARD_CATEGORY_NO     NOT NULL NUMBER(1)    
	...
	public RoutineBoardVo(int routineboardNo, String memberNickname, int routineNo, String routineboardTitle,
			...
			int routineExerciseRestTime, int routineboardR) {
		super();
		...
		this.routineboardR = routineboardR;
	}
	...
	public int getRoutineboardR() {
		return routineboardR;
	}



	public void setRoutineboardR(int routineboardR) {
		this.routineboardR = routineboardR;
	}
	...
	public String toString() {
		return "RoutineBoardVo [routineboardNo=" + routineboardNo + ", memberNickname=" + memberNickname
				...
				+ routineSetRestTime + ", routineExerciseRestTime=" + routineExerciseRestTime + ", routineboardR="
				+ routineboardR + "]";
	}
