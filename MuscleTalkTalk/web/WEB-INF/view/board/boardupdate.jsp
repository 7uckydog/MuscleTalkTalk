...
<body>
	<section>
		...
		<div id="board_information">
			<div id="writer_board">게시물 수정하기</div>
		</div>
		<form action="boardupdate.do" method="post">
			...
			<input class="board_title" name="boardTitle" type="text"
				placeholder="게시물 제목을 입력해 주세요.(최대 10자)" value="${bvo.boardTitle}">
			<div id="board_content">게시물 내용</div>
			<div class="Ckediter">
				<textarea id="board_content3" name="boardContent"
					placeholder="게시물 내용을 입력해 주세요.(최대 300자)"value="${bvo.boardContent}"></textarea>
				<script>
					CKEDITOR.replace('board_content3', {
						width : '800px',
						height : '360px',
						/* startupFocus : true, */
						uiColor : '#ffffff',
