...
DROP TABLE TB_EXERCISE_RECORD;
DROP TABLE TB_ROUTINE;
DROP TABLE TB_PT;
DROP TABLE TB_BOARD;
DROP TABLE TB_COMMENT;
DROP TABLE TB_ROUTINE_EXERCISE;
DROP TABLE TB_TRAINER;
DROP TABLE TB_BLACKLIST;
DROP TABLE TB_FAVORITE;
DROP TABLE TB_REVIEW;
DROP TABLE TB_TRADE;
DROP TABLE TB_LETTER;
DROP TABLE TB_MEMBER_BACKUP;
DROP TABLE TB_BOARD_BACKUP;
DROP TABLE TB_BOARD_REPORT;
DROP TABLE TB_COMMENT_REPORT;
DROP TABLE TB_RECOMMENT_BACKUP;
DROP TABLE TB_PT_FILE;
DROP TABLE TB_REPORT_BACKUP;
DROP TABLE TB_PT_CALENDAR;
DROP TABLE TB_VISIT;
DROP TABLE TB_EMAIL_ CERTIFICATION;
...
CREATE TABLE TB_MEMBER (
	...
	MEMBER_PURPOSE_NAME	VARCHAR2(20)		NOT NULL,
	MEMBER_CONCERN_NAME	VARCHAR2(20)		NOT NULL,
	MEMBER_PHOTO	BLOB		NULL,
	MEMBER_TRAINER	VARCAHR2(1)	DEFAULT F	NOT NULL,
	MEMBER_ABSENCE	VARCHAR2(1)	DEFAULT N	NOT NULL,
	MEMBER_JOIN_DATE	DATE	DEFAULT SYSDATE	NOT NULL,
	MEMBER_LEAVE_DATE	DATE		NULL
);

COMMENT ON COLUMN TB_MEMBER.MEMBER_PURPOSE_NAME IS '선택안함, 감량, 증량, 체력관리, 바디프로필, 기타';

COMMENT ON COLUMN TB_MEMBER.MEMBER_CONCERN_NAME IS '선택안함, 웨이트트레이닝, 필라테스, 요가, 기타';
...
CREATE TABLE TB_EXERCISE (
	...
	EXERCISE_AEROBIC	CHAR(1)	DEFAULT U	NOT NULL
);
...
CREATE TABLE TB_ROUTINE_EXERCISE (
	...
	EXERCISE_NO	NUMBER		NOT NULL,
	ROUTINE_EXERCISE_DAY	VARCHAR(3)		NOT NULL,
	ROUTINE_NO	NUMBER		NOT NULL,
	...
	ROUTINE_EXERCISE_TARGET	CHAR(1)		NULL
);
...
COMMENT ON COLUMN TB_ROUTINE_EXERCISE.ROUTINE_EXERCISE_TARGET IS 'B:등,C:가슴,L:하체,S:어깨,A:복근,E:팔,H:엉덩이,T:유산소(컨디셔닝),R:휴식';


CREATE TABLE TB_TRAINER (
	TRAINER_NO	NUMBER		NOT NULL,
	MEMBER_NO	NUMBER		NOT NULL,
	TRAINER_FILE	BLOB		NOT NULL,
...
CREATE TABLE TB_LETTER (
	...
	MEMBER_NO	NUMBER		NOT NULL,
	LETTER_CONTENT	VARCAHR2(1000)		NOT NULL,
...
ALTER TABLE TB_EMAIL_ CERTIFICATION ADD CONSTRAINT PK_TB_EMAIL_CERTIFICATION PRIMARY KEY (
...
ALTER TABLE TB_BOARD_REPORT ADD CONSTRAINT FK_TB_BOARD_TO_TB_BOARD_REPORT_1 FOREIGN KEY (
	BOARD_NO
)
REFERENCES TB_BOARD (
	BOARD_NO
...
ALTER TABLE TB_BOARD_REPORT ADD CONSTRAINT FK_TB_MEMBER_TO_TB_BOARD_REPORT_1 FOREIGN KEY (
	MEMBER_NO
)
REFERENCES TB_MEMBER (
	MEMBER_NO
...
ALTER TABLE TB_COMMENT_REPORT ADD CONSTRAINT FK_TB_COMMENT_TO_TB_COMMENT_REPORT_1 FOREIGN KEY (
	COMMENT_NO
)
...
ALTER TABLE TB_COMMENT_REPORT ADD CONSTRAINT FK_TB_MEMBER_TO_TB_COMMENT_REPORT_1 FOREIGN KEY (
	MEMBER_NO
)
REFERENCES TB_MEMBER (
	MEMBER_NO
...
ALTER TABLE TB_REPORT_BACKUP ADD CONSTRAINT FK_TB_BOARD_BACKUP_TO_TB_REPORT_BACKUP_1 FOREIGN KEY (
	BOARD_BACKUP_NO
)
...
ALTER TABLE TB_REPORT_BACKUP ADD CONSTRAINT FK_TB_RECOMMENT_BACKUP_TO_TB_REPORT_BACKUP_1 FOREIGN KEY (
	RECOMMNET_BACKUP_NO
)
...
ALTER TABLE TB_PT_CALENDAR ADD CONSTRAINT FK_TB_MEMBER_TO_TB_PT_CALENDAR_1 FOREIGN KEY (
	MEMBER_NO
)
REFERENCES TB_MEMBER (
	MEMBER_NO
...
ALTER TABLE TB_PT_IMG ADD CONSTRAINT FK_TB_PT_TO_TB_PT_IMG_1 FOREIGN KEY (
	PT_NO
)
REFERENCES TB_PT (
	PT_NO
