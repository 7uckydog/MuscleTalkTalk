...
CREATE TABLE TB_ROUTINE (
    ...
    ROUTINE_SET_REST_TIME NUMBER DEFAULT 0    NOT NULL,
    ROUTINE_EXERCISE_REST_TIME NUMBER DEFAULT 0 NOT NULL
);
...
CREATE TABLE TB_PT (
    ...
    PT_DELETE VARCHAR2(1) DEFAULT 'F' NOT NULL
);
...
CREATE TABLE TB_REVIEW (
    ...
    REVIEW_REGIST_DATE DATE DEFAULT SYSDATE NOT NULL
);
